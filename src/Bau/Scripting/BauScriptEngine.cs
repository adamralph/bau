// <copyright file="BauScriptEngine.cs" company="Bau contributors">
...
namespace Bau.Scripting
{
    ...
    public class BauScriptEngine : IScriptEngine
    {
        ...
        private readonly IBauScriptHostFactory scriptHostFactory;
        private readonly ILog log;

        [CLSCompliant(false)]
        public BauScriptEngine(IBauScriptHostFactory scriptHostFactory, ILog log)
        {
